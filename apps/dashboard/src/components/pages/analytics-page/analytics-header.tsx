...
import { type TimeframePreset, useAnalyticsStore } from "./analytics-store";
...
export default function AnalyticsHeader() {
  const timeframePreset = useAnalyticsStore((s) => s.timeframePreset);
  const dateRange = useAnalyticsStore((s) => s.dateRange);
  const setTimeframePreset = useAnalyticsStore((s) => s.setTimeframePreset);
